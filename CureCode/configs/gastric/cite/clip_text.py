_base_ = [
    ...
    '../_base_/gastric_dataset_text.py',
...
model = dict(
    ...
    backbone=dict(
        type='PromptedCLIPImageBackboneWithText',
        arch=arch,
        prompt_length=vpl,
        prompt_pos='prepend',
        prompt_init='token',
...
data = dict(
    ...
    train=dict(
        ann_file=f'data/gastric_cls3_ann_text/train_{n}_0.2.txt',
        patch_balance=True))

work_dir = f'work_dirs/gastric_cite_text/{run_name}'
